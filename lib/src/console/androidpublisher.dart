part of androidpublisher_v1_api_console;

/** Client to access the androidpublisher v1 API */
/** Lets Android application developers access their Google Play accounts. */
class Androidpublisher extends ConsoleClient {
  ...
  Androidpublisher([Object auth]) : super(auth) {
